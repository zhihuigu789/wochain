...
"""
class WochainDGPGasPriceLingeringMempoolTxTest(BitcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    def run_test(self):
        ...
        self.nodes[1].createcontract("00", 1000000, WOC_MIN_GAS_PRICE_STR)
...
if __name__ == '__main__':
    WochainDGPGasPriceLingeringMempoolTxTest().main()
