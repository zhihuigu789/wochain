...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see wochain-dgp.py
"""
class WochainDGPActivation(BitcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    def run_test(self):
        ...
        # Restart the wochaind to verify that no crashes occurs on startup
        stop_nodes(self.nodes)
        self.setup_network()


if __name__ == '__main__':
    WochainDGPActivation().main()
