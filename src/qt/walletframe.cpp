...
{
    QMap<QString, WalletView*>::const_iterator i;
this->setStyleSheet ("WalletFrame {background-color: #eef1f8;}");
    for (i = mapWalletViews.constBegin(); i != mapWalletViews.constEnd(); ++i)
...
{
 this->setStyleSheet ("WalletFrame {background-color: #272727;}");
    QMap<QString, WalletView*>::const_iterator i;
    for (i = mapWalletViews.constBegin(); i != mapWalletViews.constEnd(); ++i)
...
//bgpal.setColor (QPalette::Background, QColor (39,39,39,255));   
for (i = mapWalletViews.constBegin(); i != mapWalletViews.constEnd(); ++i)
