...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Wochains");
    case mBTC: return QString("Milli-Wochains (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Wochains (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
