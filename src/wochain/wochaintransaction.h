#ifndef WOCTRANSACTION_H
#define WOCTRANSACTION_H
...
class WochainTransaction : public dev::eth::Transaction{

public:

    WochainTransaction() : nVout(0) {}

    WochainTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
		dev::eth::Transaction(_value, _gasPrice, _gas, _data, _nonce) {}

    WochainTransaction(dev::u256 const& _value, dev::u256 const& _gasPrice, dev::u256 const& _gas, dev::Address const& _dest, dev::bytes const& _data, dev::u256 const& _nonce = dev::Invalid256):
