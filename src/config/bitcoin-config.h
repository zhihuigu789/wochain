...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Wochain Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Wochain Core"
...
#define PACKAGE_BUGREPORT "https://github.com/wochainproject/wochain/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Wochain Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Wochain Core 0.14.16"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "wochain"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://wochain.org/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "0.14.16"
