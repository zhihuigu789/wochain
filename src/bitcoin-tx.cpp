...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s wochain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  wochain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wochain transaction") + "\n" +
              "  wochain-tx [options] -create [commands]   " + _("Create hex-encoded wochain transaction") + "\n" +
              "\n";
...
static void MutateTxAddInput(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    static const unsigned int maxVout = dgpMaxBlockSize / minTxOutSz; // wochain
