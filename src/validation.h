...
/////////////////////////////////////////// wochain
#include <wochain/wochainstate.h>
#include <wochain/wochainDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <wochain/storageresults.h>
...
using ExtractWochainTX = std::pair<std::vector<WochainTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
static const size_t MAX_CONTRACT_VOUTS = 1000; // wochain
...
void EnforceContractVoutLimit(ByteCodeExecResult& bcer, ByteCodeExecResult& bcerOut, const dev::h256& oldHashWochainRoot,
    const dev::h256& oldHashStateRoot, const std::vector<WochainTransaction>& transactions);
...
class WochainTxConverter{

public:

    WochainTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransactionRef>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionWochainTransactions(ExtractWochainTX& wochainTx);
...
private:
    ...
    WochainTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<WochainTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
