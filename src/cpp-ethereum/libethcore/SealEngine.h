...
////////////////////////////////////////////////////////////// // wochain
	void setWochainSchedule(EVMSchedule _wochainSchedule) const { wochainSchedule = _wochainSchedule; }

	EVMSchedule& getWochainSchedule() const { return wochainSchedule; }
...
private:
	...
	mutable EVMSchedule wochainSchedule; // wochain
