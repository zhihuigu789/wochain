...
#include "genesis/wochainMainNetwork.cpp"
#include "genesis/wochainTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::wochainMainNetwork: return c_genesisInfoWochainMainNetwork;
	case Network::wochainTestNetwork: return c_genesisInfoWochainTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::wochainMainNetwork: return c_genesisStateRootWochainMainNetwork;
	case Network::wochainTestNetwork: return c_genesisStateRootWochainTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
