...
////////////////////////////////////////////////////////////// wochain
        ...
        globalState = std::unique_ptr<WochainState>(new WochainState(dev::u256(0), WochainState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::wochainTestNetwork)));
