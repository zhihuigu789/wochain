...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // wochain
        hashUTXORoot.SetNull(); // wochain
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //wochain
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //wochain
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //wochain
    {
